defmodule WeatherFlow.Application do
  ...
  def start(_type, _args) do
    mongo_config = Application.get_env(:weather_flow, :mongo) || [database: "weather_flow", url: "mongodb://localhost:27017", pool_size: 1]
    ...
    children = [
      ...
      {Mongo, [name: :mongo, database: mongo_config[:database], url: mongo_config[:url], pool_size: mongo_config[:pool_size] || 2]},
